...
cmd.exe /d /s /c "call `"$vs`" && cl /nologo /std:c++17 /EHsc /O2 /utf-8 /DUNICODE /D_UNICODE `"$root\src\main.cpp`" `"$root\src\battle_rules.cpp`" /Fe:`"$out\YinYangChronicle.exe`" user32.lib gdi32.lib"
