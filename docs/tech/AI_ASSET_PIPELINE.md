...
본 문서는 **『108: 음양견문록 (108: Yin-Yang Chronicle)』**의 108종 요괴, NPC, 타일셋 및 UI 그래픽 에셋을 생성형 AI와 자동화 도구 체인을 통해 제작하는 표준 운영 절차(SOP)를 정의합니다.
...
## 4. 에셋 저장 형식 분석 (4-Bit RLE vs 원시 PNG)
...
> **용량 판정:** 저장 형식은 품질·로딩 속도·배포 크기를 비교해 결정합니다.
