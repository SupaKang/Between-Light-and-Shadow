...
- **메인 캠페인**: 영맥을 왜곡하는 비밀 결사 **흑월회(黑月會)** 처치.
...
│   ├── campaign/             # 흑월회 메인 스토리 및 민담 서브퀘스트
...
- [ ] **Phase 1: Technical Spike** — 320x180 렌더러, 타일 이동, Release 크기 측정 (< 1.44MB)
- [ ] **Phase 2: Battle Prototype** — 1v1 턴제, HP/영력, 4기술, 5종 상태이상
